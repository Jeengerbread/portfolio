...
public class Outlaws extends PApplet {
...
public void draw() {
  ...
  if (timedBoolean1() == false) {
    image(outlaw1, 235, 475, 60, 98.5f);
  }
...
public void mousePressed() {
   ...
   if (mouseX > 235 && mouseX < 295 && mouseY > 475 && mouseY < 573.5f ) {
    //outlaw1 killed
    outlaw1Draw = false;
    score++;
  } 
...
private boolean timedBoolean4() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Outlaws" };
    if (passedArgs != null) {
